...
// Generated on: 2021.02.01 at 08:45:44 PM CET 
//


package com.xml.project.model.dAppealSearch;
...
@XmlRootElement(name = "dAppealSearch")
public class DAppealSearch {
	...
	public String toString() {
		return "DAppealSearch [broj=" + broj + ", datum=" + datum + ", mesto=" + mesto + ", ime=" + ime + ", prezime="
				+ prezime + ", organVlasti=" + organVlasti + ", status=" + status + "]";
	}
