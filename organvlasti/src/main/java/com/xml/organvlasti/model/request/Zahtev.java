...
public class Zahtev {
	...
	public String toString() {
		return "Zahtev [institucija=" + institucija + ", naslov=" + naslov + ", tekstZahteva=" + tekstZahteva
				+ ", mestoDatum=" + mestoDatum + ", podnosilac=" + podnosilac + ", footer=" + footer + ", id=" + id
				+ ", username=" + username + ", datum=" + datum + ", institucijaNaziv=" + institucijaNaziv + ", about="
				+ about + "]";
	}
