 ...
 * 
 */
public class DOMParserZalbaZbogCutanja implements ErrorHandler {
	...
	public static void test(Scanner scanner) {
		...
		filePath = "data/zalbazbogcutanja.xml";
		
		DOMParserZalbaZbogCutanja handler = new DOMParserZalbaZbogCutanja();
